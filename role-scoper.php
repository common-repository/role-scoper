<?php
/*
Plugin Name: Role Scoper (Obsolete - Please install PublishPress Permissions)
Plugin URI: https://publishpress.com/
Description: CMS-like permissions for reading and editing, now replaced by PublishPress Permissions. Please install Permissions to import your configuration to a supported platform.
Version: 1.5
Author: PublishPress
Author URI: https://publishpress.com/presspermit/
Min WP Version: 3.0
